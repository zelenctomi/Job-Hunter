...
- [x] Munkáltató - Profilom: Álláshirdetés szerkesztése működik (2pt) A szerkesztéshez rá kell kattintani a munkáltatóval egy munkára, ha nem az övé, akkor nem engedi szerkezteni
